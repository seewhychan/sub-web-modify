<template>
  <div>
    ...
    <el-dialog title="请选择需要观看的视频教程" :visible.sync="centerDialogVisible" :show-close="false" width="40vh" top="30vh"
      ...
      <div label-width="0px" style="text-align: center;margin: 3vh 0 2vh">
        <el-button style="width: 200px;" type="warning" icon="el-icon-download" @click="toolsDown">网络代理工具箱
        </el-button>
      </div>
    </el-dialog>
        ...
        <el-tab-pane label="JS排序节点" name="second">
          ...
          <el-form label-position="left">
            <el-form-item prop="uploadScript">
              <el-input v-model="uploadScript" placeholder="本功能暂停使用，如有兴趣，自行去肥羊的GitHub参考sub-web-api项目部署！" type="textarea"
        ...
        <el-tab-pane label="JS筛选节点" name="third">
          ...
          <el-form label-position="left">
            <el-form-item prop="uploadFilter">
              <el-input v-model="uploadFilter" placeholder="本功能暂停使用，如有兴趣，自行去肥羊的GitHub参考sub-web-api项目部署！" type="textarea"
                :autosize="{ minRows: 15, maxRows: 15 }" maxlength="50000" show-word-limit></el-input>
            </el-form-item>
          </el-form>
          <div style="float: right">
    ...
    getBackendVersion() {
      this.$axios
        ...
        .then(res => {
          ...
          let a = this.form.customBackend.indexOf("subconver.zeabur.app") !== -1;
          let b = this.form.customBackend.indexOf("127.0.0.1") !== -1;
          a ? this.$message.success(`${this.backendVersion}` + "本站自部署订阅转换后端工作正常") : b ? this.$message.success(`${this.backendVersion}` + "本地局域网自建版后端") : this.$message.success(`${this.backendVersion}`);
        })
        .catch(() => {

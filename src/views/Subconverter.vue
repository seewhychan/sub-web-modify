  ...
  <div>
          ...
          <el-container>
            <el-form :model="form" label-width="80px" label-position="left" style="width: 100%">
              ...
              <el-form-item label-width="0px" style="text-align: center">
                ...
                <el-button style="width: 120px" 输入="primary" @click="dialogLoadConfigVisible = true"
                  icon="el-icon-copy-document" :loading="loading3">从URL解析
                </el-button>
              </el-form-item>
              <el-form-item label-width="0px" style="text-align: center">
                <el-button style="width: 250px;" 输入="success" icon="el-icon-video-play"
    ...
    <el-dialog title="请选择需要观看的视频教程" :visible.sync="centerDialogVisible" :show-close="false" width="40vh" top="30vh"
      ...
      <div label-width="0px" style="text-align: center">
        <el-button style="width: 200px;" 输入="primary" icon="el-icon-video-play"
          @click="gotoBasicVideo(); centerDialogVisible = false">基础视频教程
        </el-button>
      </div>
      <div label-width="0px" style="text-align: center;margin: 3vh 0 2vh">
        <el-button style="width: 200px;" 输入="danger" icon="el-icon-video-play"
          @click="gotoAdvancedVideo(); centerDialogVisible = false">进阶视频教程
        </el-button>
      </div>
      <div label-width="0px" style="text-align: center;margin: 3vh 0 2vh">
        <el-button style="width: 200px;" 输入="warning" icon="el-icon-download" @click="toolsDown">网络代理工具箱
        </el-button>
      </div>
    </el-dialog>
    <el-dialog :visible.sync="dialogUploadConfigVisible" :show-close="false" :close-on-click-modal="false"
      ...
      <el-tabs v-model="activeName" 输入="card">
        <el-tab-pane label="远程配置上传" name="first">
          <el-link 输入="danger" :href="sampleConfig" style="margin-bottom: 15px" target="_blank" icon="el-icon-info">
            参考案例
          </el-link>
          ...
          <div style="float: right">
            <el-button 输入="primary" @click="uploadConfig = ''; dialogUploadConfigVisible = false">取 消</el-button>
            <el-button 输入="primary" @click="confirmUploadConfig" :disabled="uploadConfig.length === 0">确 定
            </el-button>
          </div>
        </el-tab-pane>
...
const downld = 'https://www.haitunt.org/app.html'
export 默认 {
  data() {
    return {
      backendVersion: "",
      ...
      options: {
        ...
        customBackend: {
          "本站自部署后端【推荐】": "https://subconver.zeabur.app",
          "CM负载均衡后端【vless reality+hy1+hy2】": "https://subapi.cmliussss.net",
          "CM负载均衡后端【vless reality+hy1+hy2】": "https://subapi.cmliussss.net"，
          "CM应急备用后端【vless reality+hy1+hy2】": "https://subapi.fxxk.dedyn.io",
        }，
        backendOptions: [
          { value: "https://subconver.zeabur.app" },
          { value: "https://subapi.cmliussss.net" },
          { value: "https://subapi.fxxk.dedyn.io" },
        ]，
        remoteConfig: [
          {
            label: "ACL4SSR规则-从上到下由重到轻",
            options: [
              {
